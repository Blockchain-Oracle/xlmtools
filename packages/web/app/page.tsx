  ...
  return (
    <main className="flex flex-1 flex-col">
      ...
      <section className="relative w-full bg-background overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 lg:py-36 grid lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          {/* Left: copy */}
          <div className="flex flex-col gap-6 sm:gap-8">
            ...
            <BlurFade delay={0.06}>
              <h1 className="text-[2.75rem] sm:text-6xl lg:text-7xl font-bold tracking-tighter leading-[0.9] text-foreground">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <Link href="/tools">
                  <ShimmerButton
                    ...
                    className="w-full sm:w-auto px-7 py-2.5 text-sm font-bold text-background rounded-full"
                  >
                    Explore Tools
                  </ShimmerButton>
                </Link>
                <Link
                  href="#how-it-works"
                  className="text-center rounded-full border border-border px-7 py-2.5 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-all"
                >
                  How It Works
                </Link>
              </div>
          ...
          {/* Right: terminal */}
          <BlurFade delay={0.10} inView className="w-full min-w-0 overflow-hidden">
            <Terminal
              className="w-full max-w-full overflow-x-auto dark:bg-[oklch(0.07_0_0)] shadow-2xl border-border/50"
              sequence
              startOnView
            >
      ...
      <section className="w-full border-y border-border bg-secondary">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <div className="mb-10 sm:mb-12">
            ...
            <h2 className="mt-3 text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-foreground leading-tight">
          ...
          <div className="grid gap-12 lg:gap-10 lg:grid-cols-2">
            <McpInstall />
            <SkillInstall />
          </div>
        </div>
