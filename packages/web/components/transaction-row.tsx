...
/**
 * Canonical call-log entry shape — matches packages/api/src/lib/call-log.ts
 * CallLogEntry exactly. Shared by the Explore activity stream and the
 * per-address Stats history.
 */
...
export function apiToTransaction(entry: ApiCallEntry, idx: number): Transaction {
  return {
